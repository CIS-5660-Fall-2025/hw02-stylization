...
- Interaction
  ...
  Press `Space` key may change the materials of some objects:
  ![](./imgs/result2.png)
...
The outline around the highlight is generated by an edge-detection effect. To make this work, the surface shader overrides the surface normals, thus providing the data the edge-detection pass needs to identify the highlight's border.
...
[Tool Box](https://sketchfab.com/3d-models/tool-box-d34059f9428e4dcbb17937e8d802de47)

[Astronaut](https://sketchfab.com/3d-models/astronaut-23b856b4b6324d179bb340ee182a5e18)
